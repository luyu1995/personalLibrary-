...
<script>
  export default {
        ...
        default: function () {
          return {
            ...
            toolbars: [[
              ...
              'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'insertframe', 'insertcode', 'pagebreak', 'background', '|',
    ...
    methods: {
      insertScriptTag () {
        window.UEDITOR_HOME_URL = this.ueditorPath;
        ...
        if (this.scriptTagStatus === 2 && this.instance === null) {
          ...
          this.$nextTick(() => {
            ...
            this.instance.addListener("contentChange", function () {
              this.wordCount = this.instance.getContentLength(true);
              this.content = this.instance.getContent();
              this.plainTxt = this.instance.getPlainTxt();
              this.$emit('change', {wordCount: this.wordCount, content: this.content, plainTxt: this.plainTxt});
            }.bind(this));
          });
        }
      },
